...
new TypeIt("#teks1", {
  strings: ["Happy Birthday my dear Batman! 🎉 With or without me, may the universe always conspire to bring you happiness in every possible way. May your days be filled with joy, success, and love, and may you always find reasons to smile. Wishing you a wonderful year ahead!"],
  startDelay: 4000,
  speed: 75,
...
new TypeIt("#teks2", {
  strings: [" ek note english me kaafi hai mere se jyada pragraphs ki expectation mat rakho, itna bhi copy paste kar ke likhi hun thank you bol dena mujhe.", " ", "- Wish all you the best"],
  startDelay: 2000,
  speed: 75,
  waitUntilVisible: true
}).go();
